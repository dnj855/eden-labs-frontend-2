<template>
  <section
    class="relative overflow-hidden bg-gradient-to-br from-secondary via-secondary to-tertiary py-10 sm:py-12 md:py-16 lg:py-24">
    <!-- Fond décoratif -->
    ...
    <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="flex flex-col space-y-10 md:space-y-12 lg:space-y-0 lg:grid lg:grid-cols-12 lg:gap-8 lg:items-center">
        <!-- Contenu textuel -->
        <div
          class="px-2 sm:px-6 text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:flex lg:items-center lg:text-left">
          <div>
            ...
            <h1
              class="font-accent mt-3 sm:mt-4 lg:mt-6 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-light">
              <span>Transformez votre</span>
              <span class="text-primary"> entreprise avec l'IA</span>
              <span
                class="font-accent block mt-2 text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold text-tertiary tracking-tight">sans
                expertise technique</span>
            </h1>
            <p class="mt-3 text-sm sm:text-base md:text-lg lg:text-xl text-light/80">
              Accompagnement sur mesure pour PME/ETI : formations, ateliers et consulting pour intégrer l'IA dans vos
            ...
            <!-- CTAs -->
            <div
              class="mt-6 sm:mt-8 md:mt-10 flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4 justify-center lg:justify-start">
              <CalButton
          ...
          <div class="relative mx-auto max-w-md sm:max-w-lg md:max-w-xl lg:max-w-none p-3 sm:p-4 lg:p-6">
            <div class="relative mx-auto w-full rounded-lg shadow-xl overflow-hidden">
              <button type="button"
                ...
                @click="showVideo = true">
                <NuxtImg format="webp" class="w-full" src="/images/home-hero.webp"
                  alt="Démonstration d'utilisation de l'IA générative" placeholder loading="lazy" preload />
                <div class="absolute inset-0 w-full h-full flex items-center justify-center">
                  <svg class="h-12 w-12 sm:h-16 sm:w-16 md:h-20 md:w-20 text-primary" fill="currentColor"
                    viewBox="0 0 84 84">
        ...
        <div class="fixed inset-0 overflow-y-auto">
          <div class="flex min-h-full items-center justify-center p-2 sm:p-4 text-center">
            <TransitionChild as="template" enter="duration-300 ease-out" enter-from="opacity-0 scale-95"
              ...
              <DialogPanel
                class="w-full max-w-sm sm:max-w-md md:max-w-2xl lg:max-w-4xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all">
                <div class="relative aspect-video">
                  <iframe class="absolute inset-0 w-full h-full"
                    src="https://www.youtube.com/embed/B5lh97-N3bE?si=igTNCHj-e_yPX6T9&autoplay=1"
